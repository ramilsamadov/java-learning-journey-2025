...
public class SoftwareDeveloper extends BaseEngineer implements IEngineer{
	
	public SoftwareDeveloper() {
		
	}	
	public SoftwareDeveloper(String name, String surname, int experience, int salary, String[] progLanguages) {
		setName(name);
		setSurname(surname);
